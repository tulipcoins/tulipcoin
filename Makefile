#############################################################################
# Makefile for building: tulipcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Jan 6 15:20:14 2018
# Project:  TulipCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile TulipCoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/TulipCoin/src/leveldb/libleveldb.a /tmp/TulipCoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: TulipCoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile TulipCoin-qt.pro
...
/tmp/TulipCoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/TulipCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/TulipCoin/build/build.h: FORCE
	cd /tmp/TulipCoin; /bin/sh share/genbuild.sh /tmp/TulipCoin/build/build.h
